...
# path_pres2022 = path + "Presidentielles_csv/pres2022comm.csv"
# data_pres2022 = pd.read_csv(path_pres2022)

# path_age = path + "Age_csv/agesexcommunes.csv"
# data_age = pd.read_csv(path_age)

# print(data_pres2022)
# print(data_age)

def importCommuneData(postcode): # Create a datapoint for a specific commune by merging all the available data on this commune
    path = "../Data/" # path to Data folder (in repo parent folder)
